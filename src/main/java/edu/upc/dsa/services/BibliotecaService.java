...
//            this.bm.addLibro("1", "libro1", "1", "2001", "1", "Pablo", "11");
//            this.bm.addLibro("2", "libro2", "2", "2002", "2", "Ema", "22");
//        }
//
//    // ---- Add lector ----
//    @POST
//    @ApiOperation(value = "Crear nuevo lector")
//    @ApiResponses(value = {
//            @ApiResponse(code = 200, message = "Successful", response = Lector.class, responseContainer = "String"),
//    })
//    @Path("/Añadir lector")
//    @Consumes(MediaType.APPLICATION_JSON)
//    @Produces(MediaType.APPLICATION_JSON)
//    public Response addLector(@QueryParam("Nombre") String nombrelector,
//                              @QueryParam("Apellido") String apellido,
//                              @QueryParam("DNI") String dni,
//                              @QueryParam("Fecha_de_nacimiento") String fechaNacimiento,
//                              @QueryParam("Lugar_de_nacimiento") String lugarNacimiento,
//                              @QueryParam("Correo_electrónico") String emai) {
//        Lector created = bm.addLector( nombrelector,  apellido,  dni,
//                                        fechaNacimiento, lugarNacimiento, emai);
//        return Response.status(Response.Status.CREATED).entity(created).build();
//    }
//
//    // ---- Añadir libro ----
//    @POST
//    @ApiOperation(value = "Añadir un libro nuevo")
//    @ApiResponses(value = {
//            @ApiResponse(code = 201, message = "Libro añadido correctamente", response = Libro.class),
